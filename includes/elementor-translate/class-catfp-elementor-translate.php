...
if ( ! class_exists( 'CATFP_Elementor_Translate' ) ) {
    /**
	 * Class CATFP_Elementor_Translate
	 *
    ...
    class CATFP_Elementor_Translate{
		 ...
		 *
		 * @return CATFP_Elementor_Translate
		 */
        ...
        public function __construct() {
            add_action('add_meta_boxes', array($this, 'catfp_elementor_post_languages'));
        }

        /**
		 * Fetch the languages for translation of elementor pages.
		 */
		function catfp_elementor_post_languages() {
			if ( isset( $_GET['_wpnonce'] ) &&
				...
				if ( function_exists( 'PLL' ) ) {
					...
					if($parent_editor === 'builder' || !empty($parent_elementor_data)){
						...
						update_post_meta( $current_post_id, '_catfp_parent_post_language_slug', $parent_post_language_slug );
					}
				}
			}
		}
