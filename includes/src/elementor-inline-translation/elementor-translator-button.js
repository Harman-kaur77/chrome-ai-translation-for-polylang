...
export default class ElementorTranslator extends Marionette.Behavior {
    ...
    ui() {
        return {
            translatorWrapper: `.catfp-et-translator-wrapper`,
        };
    }
    ...
    onRender() {
        ...
        const $button=jQuery(`<div class="catfp-et-translator-wrapper ${styles.catfpEtTranslatorWrapper}">`);

        let iconElement = document.createElement('div');
        iconElement.className=styles.catfpEtTranslatorContainer;
        iconElement.title="Chrome built-in translator AI";
        ReactDom.createRoot(iconElement).render(<RiTranslateAi2 className={styles.catfpEtTranslatorIcon} />);
