...
const ParagraphRewriter = ({ value, onChange }) => {
  const activePageLanguage = (window as any).catfpInlineTranslation?.pageLanguage || 'en';
...
registerFormatType("catfp/paragraph-rewriter", {
  object: false,
  title: "AI Paragraph Rewriter",
  name: "catfp/paragraph-rewriter",
  interactive: true,
  tagName: "catfp-paragraph-rewriter",
  className: null,
