...
const GutenbergPostFetch = async (props) => {
    ...
    let blockRules = wp.data.select('block-catfp/translate').getBlockRules() || {};
    const apiController = [];
    ...
    const BlockParseFetch = async () => {
        ...
        const blockRulesApiSendData = {
            ...
            action: catfp_global_object.action_block_rules
        };
        ...
        await fetch(apiUrl, {
            ...
            .then(data => {
                ...
                dispatch('block-catfp/translate').setBlockRules(blockRules);
