...
const AddProgressBar = (provider) => {
    ...
    const progressBarSelector = "#catfp_strings_model .catfp_translate_progress";

    if (!document.querySelector(`#catfp-${provider}-progress-bar`)) {
        const progressBar = jQuery(`
            <div id="catfp-${provider}-progress-bar" class="catfp-translate-progress-bar">
