...
const Providers = (props) => {
    ...
    const btnId = `catfp-${serviceId}-btn`;

    return (
<tr>
<td className="catfp-provider-name">
...
<td>
  {ActiveService.ButtonDisabled ? ActiveService.ErrorMessage : (
    <div
      ...
      className="catfp-service-btn button button-primary"
...
<td>
  <a href={ActiveService.Docs} target="_blank" rel="noopener noreferrer" className="catfp-doc-icon">
